...
2. **Impacto de Negocio:** El pipeline final ha generado y exportado **658,373 predicciones históricas** (desde el 24/11/2025 hasta el 13/05/2026) cubriendo **4,858 productos únicos** al archivo particionado [lstm_resultados.parquet](file:///e:/Estudios/CE_IAyBD/TFE/mercaintelligence/data/predicciones/lstm/lstm_resultados.parquet). Del total de inferencias históricas, el modelo generó **31,054 alertas de cambio de precio** (4.7% del volumen total) utilizando el umbral calibrado de 0.901, identificando **3,884 productos únicos con al menos un cambio próximo predicho**. Se consolida así una herramienta de **inteligencia competitiva**, capaz de anticipar y alertar sobre movimientos en los precios de la competencia días antes de que sucedan, ofreciendo una ventaja estratégica accionable y equilibrada.
